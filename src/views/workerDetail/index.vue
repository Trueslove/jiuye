<template>
  <div class="worker-d">
      ...
      <!-- <div class="worker-d-card">
        ...
        <div class="worker-d-card-c" style="padding-top: 0">
          <van-button
            ...
            >查看联系方式</van-button
          >
          <span style="font-size: 16px; line-height: 20px" v-if="showcontact">{{
            workerdetail.tel
          }}</span>
        </div>
      </div> -->
    ...
    <!-- <div class="worker-d-footer">
      <van-button type="primary" color="#f60" block>邀请面试</van-button>
    </div> -->
...
Vue.use(Toast);
Vue.use(Dialog);
import { workerDetailApi, workerRecordApi } from "@s/api";
export default {
  data() {
    return {
      workerdetail: {},
